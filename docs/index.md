...
Estimation](reference/figures/README-accuracy.png)

Figure 1 - Accuracy of Parameter Estimation
...
Data](reference/figures/README-pred_power_nominal.png)

Figure 2 - Predictive Power for Nominal Data
...
Data](reference/figures/README-pred_power_ordinal.png)

Figure 3 - Predictive Power for Ordinal Data
...
[`get_consequences()`](reference/get_consequences.md). Please refer to
the vignette “Calculating consequences and cut-off values”.
