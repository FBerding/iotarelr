...
[here](iotarelr.html). In the center of this kind of analysis is the function 
...
The argument `strength` is closely connected with the data type and refers to the
...
Here, the meaning of a correlation changes every .20 units. The values for lower and
...
That is, in 21.5% of the cases, the results of the significance tests imply that
...
the existence of such a relationship. The lower and the upper values imply that
...
the degree of reliability more situation-specific and can support the planning
and evaluating of studies. 
...
Second, the analysis assumes that both independent and dependent variables have
