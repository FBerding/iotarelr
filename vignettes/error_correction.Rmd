...
a part of the development phase of a coding scheme (Krippendorff, 2019; 
Kuckartz, 2018; Mayring, 2015; Schreier, 2012). That is, reliability is
...
# 2 Using the error correction of Iota Concept
Applying the error correction of *Iota Concept* requires that all coding units
...
`est_expected_categories()` and use the ratings as data source. The results
